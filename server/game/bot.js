...
(function (root, factory) {
  ...
  if (typeof module === 'object' && module.exports) {
    module.exports = factory(require('./cards'), require('./rules'));
  } else {
    root.SK = root.SK || {};
    root.SK.bot = factory(root.SK.cards, root.SK.rules);
  }
}(typeof self !== 'undefined' ? self : this, function (cards, rules) {
  'use strict';

  const { EDITIONS, TRUMP_SUIT } = cards;
  const { legalMoves } = rules;
